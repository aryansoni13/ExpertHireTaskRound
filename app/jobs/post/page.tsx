...
function PostJobForm() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      const tags = data.tags
        ...
        .filter(Boolean);
      await addJob(
        { ...data, tags, featured: false, postedBy: user.uid },
        user.uid,
      );
  ...
  const inputCls =
    "w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/30 text-sm focus:outline-none focus:border-violet-500/50 transition-colors";
      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <p className="text-white/40 mb-10">
            Help women find inclusive opportunities
          </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  className={inputCls}
                  placeholder="Describe the role, responsibilities, and what makes your company women-friendly..."
                />
                {errors.description && (
              ...
              <div>
                ...
                />
                {errors.applyUrl && (
                  <p className={errorCls}>{errors.applyUrl.message}</p>
                )}
              </div>
              <div>
                ...
                <input
                  {...register("tags")}
                  className={inputCls}
                  placeholder="React, TypeScript, Entry-level, Mentorship..."
                />
              </div>
            </div>
